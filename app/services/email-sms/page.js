...
export default function EmailSmsService() {
  return (
        ...
        <main className="flex-grow pt-32 pb-24 px-6 md:px-12 max-w-5xl mx-auto w-full relative z-10">
          ...
          <div className="space-y-6 max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-foreground/70 font-light leading-relaxed font-body">
              Raise customer lifetime value and drive repeat sales. We build segmented, automated retention campaigns and checkout recovery loops.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 my-12 border-y border-foreground/10 py-10">
            <div>
              <div className="text-4xl sm:text-5xl font-black font-heading text-[#9a0002]">38%</div>
              <div className="text-xs text-foreground/50 uppercase tracking-wider font-body mt-2">Average Total Revenue Share Driven</div>
            </div>
            <div>
              <div className="text-4xl sm:text-5xl font-black font-heading text-foreground">3x+</div>
              <div className="text-xs text-foreground/50 uppercase tracking-wider font-body mt-2">Increase in Repeat Purchase Rates</div>
            </div>
            <div>
              <div className="text-4xl sm:text-5xl font-black font-heading text-foreground">30%</div>
              <div className="text-xs text-foreground/50 uppercase tracking-wider font-body mt-2">Average Cart Recovery Boost</div>
            </div>
          </div>
          ...
          <div className="space-y-12 my-12">
            <h2 className="text-2xl md:text-3xl font-heading font-extrabold text-foreground">
              Our Retention Marketing Blueprint
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 font-body">
              <div className="p-8 rounded-[24px] border border-foreground/10 bg-surface/30">
                <h3 className="text-lg font-bold font-heading text-foreground mb-3">1. Cohort Segmentation</h3>
                <p className="text-sm text-foreground/60 leading-relaxed">
                  We categorize your buyers based on historical value, purchase count, and interest tags. We send targeted, high-context email newsletters and SMS promotions that convert.
                </p>
              </div>
              <div className="p-8 rounded-[24px] border border-foreground/10 bg-surface/30">
                <h3 className="text-lg font-bold font-heading text-foreground mb-3">2. Lifecycle Flow Automation</h3>
                <p className="text-sm text-foreground/60 leading-relaxed">
                  We deploy automated welcome pathways, checkout recovery timers, and customer win-back schedules that work 24/7 to boost your margins.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#9a0002]/5 border border-[#9a0002]/20 rounded-[32px] p-8 sm:p-12 text-center space-y-6 my-12">
            <h3 className="text-2xl sm:text-3xl font-heading font-extrabold text-foreground">
              Ready to raise your customer lifetime value?
            </h3>
            <p className="text-sm sm:text-base text-foreground/75 max-w-xl mx-auto font-body">
              Book a free Scale Audit. We'll audit your email flows, SMS subscriber segments, and retention loops, laying out exactly where you are losing revenue.
            </p>
