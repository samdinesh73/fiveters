...
const SocialFlipNode = ({
    ...
    return (
        <Wrapper
            {...wrapperProps}
            className={cn("relative h-7 w-7 cursor-pointer", itemClassName)}
...
export default function SocialFlipButton({
    ...
    return (
        <div className={cn("flex items-center justify-center gap-4 ", className)}>
            <div
                className="group relative flex items-center justify-center gap-2 rounded-2xl glass-border bg-none  shadow-none dark:bg-none"
