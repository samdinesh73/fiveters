...
export default function TeamSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full py-28 md:py-36 bg-background overflow-hidden border-t border-foreground/10"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="team-header-animate text-center md:text-left md:flex md:items-end md:justify-between mb-20">
          <div className="max-w-2xl">
            ...
            <h2 className="text-transparent bg-clip-text bg-gradient-to-r from-foreground via-foreground to-[#9a0002] text-3xl md:text-5xl font-heading font-extrabold text-foreground tracking-tight leading-tight">
          ...
          <p className="mt-6 md:mt-0 text-foreground/60 font-body text-base md:text-lg max-w-md md:text-left leading-relaxed">
        ...
        <div className="team-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12 md:gap-4 lg:gap-6 xl:gap-8 justify-center justify-items-center mt-12">
          {TEAM_MEMBERS.map((member, index) => (
            ...
            >
              ...
              <div className="relative w-full aspect-[4/5] rounded-[15px] overflow-visible mb-5 bg-surface border border-foreground/5 shadow-2xl transition-all duration-300 group-hover:border-foreground/10 group-hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
                <TiltedCard
              ...
              <div className="text-center w-full px-1">
                <p className="text-foreground/60 text-[13px] font-body leading-relaxed mb-4 min-h-[50px] line-clamp-3">
                  {member.tagline}
                </p>
                ...
                <div className="flex justify-center items-center gap-4">
                  ...
                  <a
                    ...
                    className="text-foreground/35 hover:text-[#E1306C] transform hover:scale-110 transition-all duration-200"
                  ...
                  <a
                    ...
                    className="text-foreground/35 hover:text-[#1877F2] transform hover:scale-110 transition-all duration-200"
                  ...
                  <a
                    ...
                    className="text-foreground/35 hover:text-[#0A66C2] transform hover:scale-110 transition-all duration-200"
                  ...
                  <a
                    ...
                    className="text-foreground/35 hover:text-[#25D366] transform hover:scale-110 transition-all duration-200"
