...
export default function Footer() {
  ...
  return (
    <footer className={`relative bg-background border-t ${theme === "light" ? "border-[#9a0002]" : "border-white"} text-foreground pt-24 pb-12 overflow-hidden`}>
      ...
      <ScrollFloat
        ...
        textClassName="font-heading font-extrabold text-[11vw] tracking-[0.38em] text-foreground/[0.08] leading-none uppercase pl-[0.38em] text-center"
      >
        fiveters
      </ScrollFloat>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-16">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-foreground flex items-center justify-center shadow-lg border border-foreground/10">
                <svg viewBox="0 0 24 24" width="20" height="20" className="text-background" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M13 17l5-5-5-5" />
                  <path d="M6 17l5-5-5-5" opacity="0.35" />
                </svg>
              </div>
              <span className="font-heading font-bold text-foreground tracking-tight text-xl">
                fiveters
              </span>
            </div>
            ...
            <div className="space-y-4">
              <div>
                <h4 className="text-xs font-semibold text-foreground/50 uppercase tracking-widest mb-1.5" style={{ fontFamily: "var(--font-heading)" }}>
                  Address:
                </h4>
                <p className="text-sm text-foreground/70 max-w-sm font-light leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
              ...
              <div>
                ...
                <p className="text-sm text-foreground/70 font-light" style={{ fontFamily: "var(--font-body)" }}>
                  +91 63821 18130
                </p>
                <p className="text-sm text-foreground/70 font-light hover:text-foreground transition duration-200 mt-0.5" style={{ fontFamily: "var(--font-body)" }}>
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a href="#" aria-label="Instagram" className="w-8 h-8 rounded-full border border-foreground/10 flex items-center justify-center text-foreground/60 hover:text-foreground hover:border-foreground/30 hover:scale-105 transition-all duration-200">
              ...
              <a href="#" aria-label="Twitter X" className="w-8 h-8 rounded-full border border-foreground/10 flex items-center justify-center text-foreground/60 hover:text-foreground hover:border-foreground/30 hover:scale-105 transition-all duration-200">
                <svg viewBox="0 0 24 24" width="12" height="12" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="#" aria-label="LinkedIn" className="w-8 h-8 rounded-full border border-foreground/10 flex items-center justify-center text-foreground/60 hover:text-foreground hover:border-foreground/30 hover:scale-105 transition-all duration-200">
                <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.779-1.75-1.75s.784-1.75 1.75-1.75 1.75.779 1.75 1.75-.784 1.75-1.75 1.75zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                </svg>
              </a>
              <a href="#" aria-label="YouTube" className="w-8 h-8 rounded-full border border-foreground/10 flex items-center justify-center text-foreground/60 hover:text-foreground hover:border-foreground/30 hover:scale-105 transition-all duration-200">
                <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8">
            {/* Column Company */}
            <div className="space-y-4">
              <h3 className={`text-sm font-semibold ${theme === "light" ? "text-[#9a0002]" : "text-white"}  tracking-wider font-heading`}>
                Company
              </h3>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <p className={`text-xs ${theme === "light" ? "text-[#9a0002]/40" : "text-white/40"}  font-light`} style={{ fontFamily: "var(--font-body)" }}>
